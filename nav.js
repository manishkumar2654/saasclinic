...
export function initNavbar() {
  ...
  document.querySelectorAll(".nav-link").forEach((a) => {
    ...
    if (target === path) {
      a.classList.add("active", "text-emerald-700");
      underline?.classList.remove("w-0");
      underline?.classList.add("w-7");
    } else {
      a.classList.remove("active", "text-emerald-700");
  ...
  document.querySelectorAll(".m-link").forEach((a) => {
    ...
    if (target === path) {
      a.classList.add("active", "bg-emerald-50", "text-emerald-700");
    } else {
      a.classList.remove("active", "bg-emerald-50", "text-emerald-700");
    }
  });
}